// Platform Tests - Kernel Version Parsing
//
// NOTE: Platform-specific tests (Windows, Unix, cross-platform) are not implemented
// as standalone tests because they would require importing from src/ (socket.zig,
// platform.zig), which creates circular dependencies in the standalone test architecture.
//
// These tests focus on kernel version parsing for io_uring feature detection.
